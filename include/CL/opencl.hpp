...
#ifndef CL_WRAPPER_NS
#define CL_WRAPPER_NS
#endif
...
struct ReferenceHandler<cl_device_id>
{
    ...
    { return CL_WRAPPER_NS::clRetainDevice(device); }
    /**
     * Retain the device.
     * \param device A valid device created using createSubDevices
     * \return 
    ...
    { return CL_WRAPPER_NS::clReleaseDevice(device); }
};
...
struct ReferenceHandler<cl_context>
{
    ...
    { return CL_WRAPPER_NS::clRetainContext(context); }
    static cl_int release(cl_context context)
    { return CL_WRAPPER_NS::clReleaseContext(context); }
};
...
struct ReferenceHandler<cl_command_queue>
{
    ...
    { return CL_WRAPPER_NS::clRetainCommandQueue(queue); }
    static cl_int release(cl_command_queue queue)
    { return CL_WRAPPER_NS::clReleaseCommandQueue(queue); }
};
...
struct ReferenceHandler<cl_mem>
{
    ...
    { return CL_WRAPPER_NS::clRetainMemObject(memory); }
    static cl_int release(cl_mem memory)
    { return CL_WRAPPER_NS::clReleaseMemObject(memory); }
};
...
struct ReferenceHandler<cl_sampler>
{
    ...
    { return CL_WRAPPER_NS::clRetainSampler(sampler); }
    static cl_int release(cl_sampler sampler)
    { return CL_WRAPPER_NS::clReleaseSampler(sampler); }
};
...
struct ReferenceHandler<cl_program>
{
    ...
    { return CL_WRAPPER_NS::clRetainProgram(program); }
    static cl_int release(cl_program program)
    { return CL_WRAPPER_NS::clReleaseProgram(program); }
};
...
struct ReferenceHandler<cl_kernel>
{
    ...
    { return CL_WRAPPER_NS::clRetainKernel(kernel); }
    static cl_int release(cl_kernel kernel)
    { return CL_WRAPPER_NS::clReleaseKernel(kernel); }
};
...
struct ReferenceHandler<cl_event>
{
    ...
    { return CL_WRAPPER_NS::clRetainEvent(event); }
    static cl_int release(cl_event event)
    { return CL_WRAPPER_NS::clReleaseEvent(event); }
};
    ...
    */
    ...
    cl_int getInfo(cl_device_info name, T* param) const
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetDeviceInfo, object_, name, param),
    ...
    static void makeDefault() {
        ...
        */
...
#endif
        {
            ...
            cl_int err = CL_WRAPPER_NS::clGetPlatformIDs(0, NULL, &n);
            if (err != CL_SUCCESS) {
                default_error_ = err;
                return;
            }
            ...
            err = CL_WRAPPER_NS::clGetPlatformIDs(n, ids.data(), NULL);
            if (err != CL_SUCCESS) {
                default_error_ = err;
                return;
            }
...
public:
    ...
    */
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetPlatformInfo, object_, name, param),
        ...
        vector<Device>* devices) const
    {
        ...
        cl_int err = CL_WRAPPER_NS::clGetDeviceIDs(object_, type, 0, NULL, &n);
        ...
        vector<cl_device_id> ids(n);
        if (n>0) {
            err = CL_WRAPPER_NS::clGetDeviceIDs(object_, type, n, ids.data(), NULL);
            if (err != CL_SUCCESS) {
                return detail::errHandler(err, __GET_DEVICE_IDS_ERR);
            }
        }
   ...
   /*! \brief Get the list of available D3D10 devices.
    ...
    unloadCompiler()
    {
        return CL_WRAPPER_NS::clUnloadPlatformCompiler(object_);
    }
#endif // CL_HPP_TARGET_OPENCL_VERSION >= 120
}; // class Platform
...
UnloadCompiler()
{
    return CL_WRAPPER_NS::clUnloadCompiler();
}
#endif // #if defined(CL_USE_DEPRECATED_OPENCL_1_1_APIS)
...
public:
    ...
    */
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateContext(
...
#endif
        object_ = CL_WRAPPER_NS::clCreateContextFromType(
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetContextInfo, object_, name, param),
        ...
        vector<ImageFormat>* formats) const
    {
        ...
        cl_int err = CL_WRAPPER_NS::clGetSupportedImageFormats(
           object_, 
           flags,
           type, 
           0, 
        ...
        if (numEntries > 0) {
            ...
            err = CL_WRAPPER_NS::clGetSupportedImageFormats(
                object_,
                flags,
                type,
                numEntries,
...
public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetEventInfo, object_, name, param),
    ...
    cl_int getProfilingInfo(cl_profiling_info name, T* param) const
    {
        return detail::errHandler(detail::getInfo(
                &CL_WRAPPER_NS::clGetEventProfilingInfo, object_, name, param),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clWaitForEvents(1, &object_),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetEventCallback(
                object_,
                type,
                pfn_notify,
                user_data), 
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateUserEvent(
            context(),
            &error);
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetUserEventStatus(object_,status),
...
public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetMemObjectInfo, object_, name, param),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetMemObjectDestructorCallback(
                object_,
                pfn_notify,
                user_data), 
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateBuffer(context(), flags, size, host_ptr, &error);
    ...
    */
        ...
        cl_int * err = NULL)
    {
        Buffer result;
        cl_int error;
        result.object_ = CL_WRAPPER_NS::clCreateSubBuffer(
            object_, 
            flags, 
            buffer_create_type, 
            buffer_create_info, 
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateFromGLBuffer(
            context(),
            flags,
            bufobj,
            &error);
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clGetGLObjectInfo(object_,type,gl_object_name),
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateFromGLRenderbuffer(
            context(),
            flags,
            bufobj,
            &error);
...
public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetImageInfo, object_, name, param),
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateImage(
            context(), 
            flags, 
            &format, 
            &desc, 
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        if (!useCreateImage)
        {
            object_ = CL_WRAPPER_NS::clCreateImage2D(
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateFromGLTexture2D(
            context(),
            flags,
            target,
            miplevel,
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        if (!useCreateImage)
        {
            object_ = CL_WRAPPER_NS::clCreateImage3D(
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateFromGLTexture3D(
            context(),
            flags,
            target,
            miplevel,
...
public:
    ...
    {
        cl_int error;
        object_ = CL_WRAPPER_NS::clCreateFromGLTexture(
            context(), 
            flags, 
            target,
            miplevel,
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreatePipe(context(), flags, packet_size, max_packets, nullptr, &error);
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetPipeInfo, object_, name, param),
            __GET_PIPE_INFO_ERR);
    }
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        cl_sampler_properties sampler_properties[] = {
            ...
            0 };
        object_ = CL_WRAPPER_NS::clCreateSamplerWithProperties(
            context(),
            sampler_properties,
            &error);
...
#else
        object_ = CL_WRAPPER_NS::clCreateSampler(
            context(),
            normalized_coords,
            addressing_mode,
            filter_mode,
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetSamplerInfo, object_, name, param),
...
public:
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetKernelInfo, object_, name, param),
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetKernelArgInfo, object_, argIndex, name, param),
        ...
        const Device& device, cl_kernel_work_group_info name, T* param) const
    {
        return detail::errHandler(
            detail::getInfo(
                &CL_WRAPPER_NS::clGetKernelWorkGroupInfo, object_, device(), name, param),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetKernelArgSVMPointer(object_, index, argPtr.get()),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetKernelArgSVMPointer(object_, index, argPtr.data()),
            __SET_KERNEL_ARGS_ERR);
    }
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetKernelArgSVMPointer(object_, index, argPtr),
            __SET_KERNEL_ARGS_ERR);
    }
#endif // #if CL_HPP_TARGET_OPENCL_VERSION >= 200
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetKernelArg(object_, index, size, argPtr),
            __SET_KERNEL_ARGS_ERR);
    }
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetKernelExecInfo(
                object_,
...
public:
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateProgramWithSource(
        ...
        if (error == CL_SUCCESS && build) {
            ...
            error = CL_WRAPPER_NS::clBuildProgram(
                object_,
                0,
                NULL,
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateProgramWithIL(
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateProgramWithBinary(
        ...
        cl_int* err = NULL)
    {
        ...
        object_ = CL_WRAPPER_NS::clCreateProgramWithBuiltInKernels(
            context(), 
        ...
        void* data = NULL) const
    {
        ...
        cl_int buildError = CL_WRAPPER_NS::clBuildProgram(
            object_,
            (cl_uint)
            devices.size(),
            deviceIDs.data(),
    ...
    cl_int compile(
        ...
        void* data = NULL) const
    {
        cl_int error = CL_WRAPPER_NS::clCompileProgram(
            object_,
            0,
            NULL,
            options,
    ...
    {
        return detail::errHandler(
            detail::getInfo(&CL_WRAPPER_NS::clGetProgramInfo, object_, name, param),
        ...
        const Device& device, cl_program_build_info name, T* param) const
    {
        return detail::errHandler(
            detail::getInfo(
                &CL_WRAPPER_NS::clGetProgramBuildInfo, object_, device(), name, param),
    ...
    {
        cl_uint numKernels;
        cl_int err = CL_WRAPPER_NS::clCreateKernelsInProgram(object_, 0, NULL, &numKernels);
        if (err != CL_SUCCESS) {
        ...
        err = CL_WRAPPER_NS::clCreateKernelsInProgram(
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetProgramReleaseCallback(
                object_,
                pfn_notify,
                user_data),
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clSetProgramSpecializationConstant(
                object_,
                index,
                sizeof(value),
                &value),
    ...
    cl_int* err = NULL) 
{
    ...
    cl_program prog = CL_WRAPPER_NS::clLinkProgram(
        ctx(),
        0,
        NULL,
        options,
...
inline Kernel::Kernel(const Program& program, const char* name, cl_int* err)
{
    ...
    object_ = CL_WRAPPER_NS::clCreateKernel(program(), name, &error);
...
public:
        ...
        if (error != CL_SUCCESS) {
            ...
            if (useWithProperties) {
                ...
                if ((properties & CL_QUEUE_ON_DEVICE) == 0) {
                    object_ = CL_WRAPPER_NS::clCreateCommandQueueWithProperties(
            ...
            if (!useWithProperties) {
                object_ = CL_WRAPPER_NS::clCreateCommandQueue(
    ...
    */
    ...
    cl_int getInfo(cl_command_queue_info name, T* param) const
    {
        return detail::errHandler(
            detail::getInfo(
                &CL_WRAPPER_NS::clGetCommandQueueInfo, object_, name, param),
        ...
        Event* event = NULL) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueReadBuffer(
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueWriteBuffer(
                object_, buffer(), blocking, offset, size,
                ptr,
                (events != NULL) ? (cl_uint) events->size() : 0,
                (events != NULL && events->size() > 0) ? (cl_event*) &events->front() : NULL,
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueCopyBuffer(
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueReadBufferRect(
                object_, 
                buffer(), 
                blocking,
                buffer_offset.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueWriteBufferRect(
                object_, 
                buffer(), 
                blocking,
                buffer_offset.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueCopyBufferRect(
                object_, 
                src(), 
                dst(), 
                src_origin.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueFillBuffer(
                object_, 
                buffer(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueReadImage(
                object_, 
                image(), 
                blocking, 
                origin.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueWriteImage(
                object_, 
                image(), 
                blocking, 
                origin.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueCopyImage(
                object_, 
                src(), 
                dst(), 
                src_origin.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueFillImage(
                object_, 
                image(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueCopyImageToBuffer(
                object_, 
                src(), 
                dst(), 
                src_origin.data(),
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueCopyBufferToImage(
                object_, 
                src(), 
                dst(), 
                src_offset,
        ...
        cl_int* err = NULL) const
    {
        cl_event tmp;
        cl_int error;
        void * result = CL_WRAPPER_NS::clEnqueueMapBuffer(
        ...
        cl_int* err = NULL) const
    {
        cl_event tmp;
        cl_int error;
        void * result = CL_WRAPPER_NS::clEnqueueMapImage(
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueUnmapMemObject(
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueSVMUnmap(
        ...
        Event *event = 0) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueMarkerWithWaitList(
                object_,
                (events != NULL) ? (cl_uint) events->size() : 0,
                (events != NULL && events->size() > 0) ? (cl_event*) &events->front() : NULL,
                (event != NULL) ? &tmp : NULL),
        ...
        Event *event = 0) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueBarrierWithWaitList(
                object_,
                (events != NULL) ? (cl_uint) events->size() : 0,
                (events != NULL && events->size() > 0) ? (cl_event*) &events->front() : NULL,
                (event != NULL) ? &tmp : NULL),
        ...
        ) const
    {
        ...
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueMigrateMemObjects(
                object_, 
        ...
        Event* event = NULL) const
    {
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueNDRangeKernel(
        ...
        Event* event = NULL) const
    {
        ...
        cl_event tmp;
        cl_int err = detail::errHandler(
            CL_WRAPPER_NS::clEnqueueNativeKernel(
 ...
 */
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clEnqueueWaitForEvents(
                object_,
                (cl_uint) events.size(),
    ...
    cl_int enqueueAcquireGLObjects(
         ...
         Event* event = NULL) const
     {
        cl_event tmp;
        cl_int err = detail::errHandler(
             CL_WRAPPER_NS::clEnqueueAcquireGLObjects(
                 object_,
                 (mem_objects != NULL) ? (cl_uint) mem_objects->size() : 0,
    ...
    cl_int enqueueReleaseGLObjects(
         ...
         Event* event = NULL) const
     {
        cl_event tmp;
        cl_int err = detail::errHandler(
             CL_WRAPPER_NS::clEnqueueReleaseGLObjects(
                 object_,
                 (mem_objects != NULL) ? (cl_uint) mem_objects->size() : 0,
                 (mem_objects != NULL && mem_objects->size() > 0) ? (const cl_mem *) &mem_objects->front(): NULL,
                 (events != NULL) ? (cl_uint) events->size() : 0,
 ...
 */
    ...
    {
        return detail::errHandler(
            CL_WRAPPER_NS::clEnqueueBarrier(object_),
    ...
    */
        ...
        cl_int *err = nullptr)
    {
        ...
        DeviceCommandQueue deviceQueue(
            CL_WRAPPER_NS::clCreateCommandQueueWithProperties(
            context(), device(), queue_properties, &error));
